...
urlpatterns = [
    ...
    path("user/auth/", views.CustomTokenObtainPairView.as_view(), name="token_obtain_view"),
    ...
    path("user/auth/change-password", views.ChangePasswordView.as_view(), name="change_password"),
    # drf swagger ui
